...
ref_speaker_list.change(fn=change_current_speaker,
                        inputs=[ref_speaker_list,speaker_value_text,show_ref_speaker_from_list],
                        outputs=[ref_speaker_list,speaker_value_text,ref_speaker_example])

update_ref_speaker_list_btn.click(fn=update_speakers_list,
                                  inputs=[ref_speaker_list,speaker_value_text,speaker_path_text,speaker_ref_wavs],
                                  outputs=[ref_speaker_list,speaker_value_text])

show_ref_speaker_from_list.change(fn=switch_speaker_example_visibility,
                                  inputs=[ref_speaker_example,show_ref_speaker_from_list,ref_speaker_list,speaker_value_text],
...
ref_speaker.stop_recording(fn=change_current_speaker_audio,
                           inputs=[improve_reference_resemble,improve_reference_audio,auto_cut,ref_speaker,speaker_path_text,speaker_value_text,ref_speaker_list,use_resample,speaker_ref_wavs],
...
ref_speaker.clear(fn=clear_current_speaker_audio,
                  inputs=[ref_speaker,speaker_path_text,speaker_value_text,ref_speaker_list,speaker_ref_wavs],
...
ref_speakers.upload(fn=create_multiple_reference,
                    inputs=[ref_speakers,use_resample,improve_reference_audio,auto_cut,improve_reference_resemble,speaker_value_text],
