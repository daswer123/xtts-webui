...
save_speaker_btn.click(fn=save_speaker,
                       inputs=[speaker_wav_save_name,speaker_path_text,ref_speaker_list,speaker_ref_wavs],
...
save_multiple_speaker_btn.click(fn=save_speaker_multiple,
                                inputs=[speaker_wav_save_name,ref_speaker_list,ref_speakers,speaker_ref_wavs,speaker_path_text],
